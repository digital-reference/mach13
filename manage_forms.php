 ...
 ********************************************************************************/
	...
	if($_SESSION['form_stats_refreshed'] !== true){
		if(!empty($_SESSION['mf_user_privileges']['priv_administer'])){
			mf_refresh_form_stats($dbh);
		}else{
			mf_refresh_form_stats($dbh,$_SESSION['mf_user_id']);
		}
	...
	//if the user sorted the form based on total/today entries, make sure to refresh ap_form_stats table
	if($form_sort_by == 'today_entries' || $form_sort_by == 'total_entries'){
		if(!empty($_SESSION['mf_user_privileges']['priv_administer'])){
			mf_refresh_form_stats($dbh);
		}else{
			mf_refresh_form_stats($dbh,$_SESSION['mf_user_id']);
				...
				<div class="content_body_sidebar">
					<div id="smart_folder_container">
						<ul id="smart_folder_list">
							<li class="smart_folder_header">Smart Folders <a title="Manage Folders" class="manage_folders" href="manage_folders.php"><span class="icon-cog"></span></a></li>
				...
				<div class="content_body_main">
					<?php if(!empty($form_list_array) || (empty($form_list_array) && !empty($selected_folder_id) && $selected_folder_id != 1 )){ ?>	
						...
						<div id="mf_top_pane">
							...
							<template id="mf_sort_pane_content">
