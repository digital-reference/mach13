					...
					<div id="element_properties_form">
						...
						<li class="clear" id="prop_file_options">
							...
							<span>
									...
									<span class="icon-question helpicon" data-tippy-content="You can block or only allow certain file types to be uploaded. Enter the file types extension into the textbox, separate them with commas. (example: jpg,gif,png,bmp)"></span>
									...
									<span class="icon-question helpicon" data-tippy-content="Checking this option will enable advanced functionality, such as Upload Progress Bar, Multiple File Uploads, AJAX uploads, File Size Limit, etc. This option is recommended to be enabled."></span>	
							</span>
