 ...
 ********************************************************************************/
	...
	if(!empty($font_items)){
		...
		$query = "INSERT INTO ".MF_TABLE_PREFIX."fonts(font_id,font_origin,font_family,font_variants,font_variants_numeric) values(?,?,?,?,?)";
		...
		foreach ($font_items as $font){
			...
			$params = array($i,'google',$font->family,$variant_imploded,$variant_numeric_imploded);
